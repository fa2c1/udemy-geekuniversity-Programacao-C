...
// Teste de tipos de caracteres -> exemplo no programa64.c

//isalnum() verifica se o caractere é alfanumérico (abc749)
...
//isspace() se é um eapaço ( )
//isupper() é maiúscula
//tolower() converte para minúscila
